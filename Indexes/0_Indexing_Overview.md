...
## 4️⃣ SP-GiST (Space-Partitioned GiST)
...
## 8️⃣ RUM (extension, advanced GIN)
...
## 9️⃣ Partial indexes (modifier, not a type)
...
## 1️⃣1️⃣ Covering indexes (`INCLUDE`) (modifier)
...
…and I’ll tell you exactly which indexes are worth having — and which ones you should delete.
